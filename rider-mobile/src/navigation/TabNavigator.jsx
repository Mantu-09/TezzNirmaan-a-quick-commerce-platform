...
import AccountSettingsScreen   from '../screens/profile/AccountSettingsScreen';  // R8
...
import RiderBankAccountScreen   from '../screens/rider/RiderBankAccountScreen';     // P10-4 — Session E gap fix
import CodCollectionScreen      from '../screens/rider/CodCollectionScreen';        // R3 — COD flow
...
function EarningsStack() {
  return (
    <Stack.Navigator screenOptions={defaultStackOptions}>
      ...
      <Stack.Screen name="RiderBankAccount" component={RiderBankAccountScreen} options={{ title: 'Bank Account' }} />
    </Stack.Navigator>
  );
}

// ── Route stack (P3-B + P9-4 ─ rider only) ────────────────────
// Route: RiderHome → RiderRoute → RiderDelivery → RiderIssue → CodCollection
function RouteStack() {
  return (
    <Stack.Navigator screenOptions={defaultStackOptions}>
      <Stack.Screen
      ...
      />
      {/* R3: COD cash collection — shown after delivering a COD order */}
      <Stack.Screen
        name="CodCollection"
        component={CodCollectionScreen}
        options={{ title: 'Collect Cash', headerLeft: () => null }}
      />
    </Stack.Navigator>
  );
}
