'use client';
// Next.js error.jsx — Admin New Rider form
// Shown when an unhandled error is thrown in the riders/new segment.
import { useEffect } from 'react';

export default function AdminNewRiderError({ error, reset }) {
  useEffect(() => {
    console.error('[AdminNewRider Error]', error);
  }, [error]);
    ...
    <div style={{ padding: 'var(--s6)', fontFamily: 'var(--font)', maxWidth: 640 }}>
      <div style={{
        ...
        <p style={{
          ...
          {error?.message || 'An unexpected error occurred while loading the new rider form.'}
        </p>
