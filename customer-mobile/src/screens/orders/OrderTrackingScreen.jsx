  ...
  return (
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        {/* R12: Download Receipt — visible for delivered orders */}
        {isDelivered && (
          <TouchableOpacity
            style={styles.receiptBtn}
            onPress={async () => {
              try {
                const url = await ordersApi.getReceiptUrl(orderId);
...
const styles = StyleSheet.create({
  ...
  // R12: Download Receipt button
  receiptBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    gap: Spacing[2], paddingVertical: Spacing[3], marginTop: Spacing[3],
