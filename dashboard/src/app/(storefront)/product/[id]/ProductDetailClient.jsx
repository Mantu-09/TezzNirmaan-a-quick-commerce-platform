...
export default function ProductDetailClient({ product }) {
  ...
  const handleAdd = () => {
    addItem({
      ...
      unit:            product.unit,
      shop_slug:       'sharma-hardware-patna',
      quantity:        qty,
    });
    setAdded(true);
        ...
        <div>
          ...
          <div className="sf-detail-actions">
            {cartQty === 0
              ...
              : (
                <Link href="/storefront/cart" className="sf-checkout-btn sf-btn-lg" style={{ flex: 2 }}>
                  🛒 View Cart ({cartQty} in cart)
                </Link>
              )
            }
            <Link href="/storefront/cart" className="sf-btn sf-btn-ghost sf-btn-lg" style={{ flex: 1, justifyContent: 'center' }}>
              Buy Now
            </Link>
          </div>
